...
class DirectPlugin(ImagerPlugin):
    ...
    def __init__(self, wks_file, rootfs_dir, bootimg_dir, kernel_dir,
        ...
        # The default device to be installed on
        image_path = "/dev/sdc"
    ...
    def print_info(self):
        ...
        """
        msg = "The system had been installed to:\n"
        ...
        msg += 'The following build artifacts were used to deploy the system:\n'
        for part in self.parts:
